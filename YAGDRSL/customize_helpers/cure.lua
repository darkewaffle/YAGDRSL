--[[
@User
This function can be called in HookPrecastTerminateSpell to adjust which Cure is cast based on [estimated] missing HP of target and the [estimated] amount cured by each Cure 1-6.
...
It is recommended that you simply implement this function in the HookPrecastTerminateSpell definition in your job logic file(s) and call it with cure potency values appropriate for your equipment.
