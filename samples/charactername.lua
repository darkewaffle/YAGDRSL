...
-- The others will simply use a safe, default value.
	...
	-- OTHER SETTINGS
		...
		-- Precast has some simple checks in place that will cancel an action (and will not change gear) if another action is already in progress, if the action is on recast or if the action is a Weaponskill and the character has <1000 TP.
